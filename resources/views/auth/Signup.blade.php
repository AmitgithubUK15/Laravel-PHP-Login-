               ...
               <div>
                    <div>
                      <form action="/auth/SignupApi" method="post" class='flex flex-col gap-5'>
                        <!-- {/* name */} -->
                        <div>
                          <label for="name" className='text-sm font-semibold'>Name </label> <br />
                          <input type="text" name="name" class='outline-none text-md border-b border-black  w-full py-2 px-1'
